 ...
 * @extends {ItemSheet}
 */
export class DEVASTRABenedictionOuMaledictionSheet extends foundry.appv1.sheets.ItemSheet {
  /** @inheritdoc */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["devastra", "sheet", "benedictionoumaledictionsheet"],
      template: "systems/devastra/templates/item/benedictionoumalediction-sheet.html",
      width: 450,
      height: 520,
